...
# find libsycl.so
find_library(DPCPP_LIB NAMES sycl PATHS "${DPCPP_ROOT}/build/lib")
...
message(STATUS "Enable SYCL: " ${DPCPP_ROOT})
include_directories("${DPCPP_ROOT}/build/include;${DPCPP_ROOT}/build/include/sycl")
link_libraries(${DPCPP_LIB})
add_definitions(-DSYCL_CXX_COMPILER="${DPCPP_ROOT}/build/bin/clang++")
