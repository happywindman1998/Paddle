...
##find_library(LIBSTDCXX NAMES stdc++ PATHS /usr/lib/gcc/x86_64-linux-gnu/11/)
##if(LIBSTDCXX)
##  target_link_libraries(cblas PRIVATE ${LIBSTDCXX})
##else()
##  message(FATAL_ERROR "C++ standard library not found")
##endif()
