//#include "paddle/cinn/backends/Sycl_util.h"
...
CINN_REGISTER_HELPER(cinn_sycl_host_api) {
  ...
  using cinn::runtime::Sycl::cinn_call_onednn_softmax_forward;
  REGISTER_EXTERN_FUNC_HELPER(cinn_call_onednn_softmax_forward,
                              cinn::common::DefaultHostTarget())
      .SetRetType<void>()
      .AddInputType<void *>()  // args
      .AddInputType<int>()     // num_args
  ...
  using cinn::runtime::Sycl::cinn_call_onednn_softmax_backward;
  REGISTER_EXTERN_FUNC_HELPER(cinn_call_onednn_softmax_backward,
                              cinn::common::DefaultHostTarget())
      .SetRetType<void>()
      .AddInputType<void *>()  // args
      .AddInputType<int>()     // num_args
...
#define REGISTER_EXTERN_FUNC_1_IN_1_OUT_BOOL(func__) \
  REGISTER_EXTERN_SOURCE_FUNC_1_IN_1_OUT(            \
      cinn_sycl_##func__##_bool, target, bool, bool)
...
#define REGISTER_EXTERN_FUNC_2_IN_1_OUT_BOOL(func__) \
  REGISTER_EXTERN_SOURCE_FUNC_2_IN_1_OUT(            \
      cinn_sycl_##func__##_bool, target, bool, bool, bool)
...
#define REGISTER_EXTERN_FUNC_1_IN_1_OUT_UINT8(func__) \
  REGISTER_EXTERN_SOURCE_FUNC_1_IN_1_OUT(             \
      cinn_sycl_##func__##_uint8, target, uint8_t, uint8_t)
...
#define REGISTER_EXTERN_FUNC_2_IN_1_OUT_UINT8(func__) \
  REGISTER_EXTERN_SOURCE_FUNC_2_IN_1_OUT(             \
      cinn_sycl_##func__##_uint8, target, uint8_t, uint8_t, uint8_t);
...
#define REGISTER_EXTERN_FUNC_1_IN_1_OUT_INT8(func__) \
  REGISTER_EXTERN_SOURCE_FUNC_1_IN_1_OUT(            \
      cinn_sycl_##func__##_int8, target, int8_t, int8_t)
...
#define REGISTER_EXTERN_FUNC_2_IN_1_OUT_INT8(func__) \
  REGISTER_EXTERN_SOURCE_FUNC_2_IN_1_OUT(            \
      cinn_sycl_##func__##_int8, target, int8_t, int8_t, int8_t);
...
#define REGISTER_EXTERN_FUNC_1_IN_1_OUT_INT16(func__) \
  REGISTER_EXTERN_SOURCE_FUNC_1_IN_1_OUT(             \
      cinn_sycl_##func__##_int16, target, int16_t, int16_t)
...
#define REGISTER_EXTERN_FUNC_2_IN_1_OUT_INT16(func__) \
  REGISTER_EXTERN_SOURCE_FUNC_2_IN_1_OUT(             \
      cinn_sycl_##func__##_int16, target, int16_t, int16_t, int16_t);
...
#define REGISTER_EXTERN_FUNC_1_IN_1_OUT_FLOAT(func__) \
  REGISTER_EXTERN_SOURCE_FUNC_1_IN_1_OUT(             \
      cinn_sycl_##func__##_fp32, target, float, float);
...
#define REGISTER_EXTERN_FUNC_1_IN_FLOAT_1_OUT_BOOL(func__) \
  REGISTER_EXTERN_SOURCE_FUNC_1_IN_1_OUT(                  \
      cinn_sycl_##func__##_fp32, target, float, bool);
...
#define REGISTER_EXTERN_FUNC_2_IN_1_FLOAT(func__) \
  REGISTER_EXTERN_SOURCE_FUNC_2_IN_1_OUT(         \
      cinn_sycl_##func__##_fp32, target, float, float, float);
...
#define REGISTER_EXTERN_FUNC_1_IN_1_FP64(func__) \
  REGISTER_EXTERN_SOURCE_FUNC_1_IN_1_OUT(        \
      cinn_sycl_##func__##_fp64, target, double, double);
...
#define REGISTER_EXTERN_FUNC_1_IN_FP64_1_OUT_BOOL(func__) \
  REGISTER_EXTERN_SOURCE_FUNC_1_IN_1_OUT(                 \
      cinn_sycl_##func__##_fp64, target, double, bool);
...
#define REGISTER_EXTERN_FUNC_2_IN_1_FP64(func__) \
  REGISTER_EXTERN_SOURCE_FUNC_2_IN_1_OUT(        \
      cinn_sycl_##func__##_fp64, target, double, double, double);
...
#define REGISTER_EXTERN_FUNC_1_IN_1_INT32(func__) \
  REGISTER_EXTERN_SOURCE_FUNC_1_IN_1_OUT(         \
      cinn_sycl_##func__##_int32, target, int, int);
...
#define REGISTER_EXTERN_FUNC_1_IN_1_INT64(func__) \
  REGISTER_EXTERN_SOURCE_FUNC_1_IN_1_OUT(         \
      cinn_sycl_##func__##_int64, target, int64_t, int64_t);
...
#define REGISTER_EXTERN_FUNC_2_IN_1_INT32(func__) \
  REGISTER_EXTERN_SOURCE_FUNC_2_IN_1_OUT(         \
      cinn_sycl_##func__##_int32, target, int, int, int);
...
#define REGISTER_EXTERN_FUNC_2_IN_1_INT64(func__) \
  REGISTER_EXTERN_SOURCE_FUNC_2_IN_1_OUT(         \
      cinn_sycl_##func__##_int64, target, int64_t, int64_t, int64_t);
...
#undef REGISTER_EXTERN_FUNC_2_IN_1_INT64
  ...
  REGISTER_FACKED_EXTERN_FUNC_HELPER(cinn_sycl_find_int, target)
      .SetRetType<int>()
  ...
  REGISTER_FACKED_EXTERN_FUNC_HELPER(cinn_sycl_find_float, target)
      .SetRetType<int>()
      .AddInputType<cinn_buffer_t *>()
      .AddInputType<int>()
      .AddInputType<float>()
  ...
  REGISTER_FACKED_EXTERN_FUNC_HELPER(cinn_sycl_find_int_nd, target)
      .SetRetType<int>()
      .AddInputType<cinn_buffer_t *>()
      .AddInputType<int>()
      .AddInputType<int>()
  ...
  REGISTER_FACKED_EXTERN_FUNC_HELPER(cinn_sycl_find_float_nd, target)
      .SetRetType<int>()
      .AddInputType<cinn_buffer_t *>()
      .AddInputType<int>()
      .AddInputType<float>()
  ...
  REGISTER_FACKED_EXTERN_FUNC_HELPER(cinn_sycl_find_int_from, target)
      .SetRetType<int>()
      .AddInputType<cinn_buffer_t *>()
      .AddInputType<int>()
      .AddInputType<int>()
  ...
  REGISTER_FACKED_EXTERN_FUNC_HELPER(cinn_sycl_find_float_from, target)
      .SetRetType<int>()
      .AddInputType<cinn_buffer_t *>()
      .AddInputType<int>()
      .AddInputType<float>()
  ...
  REGISTER_FACKED_EXTERN_FUNC_HELPER(cinn_sycl_next_smallest_int32, target)
      .SetRetType<int>()
      .AddInputType<cinn_buffer_t *>()
      .AddInputType<int>()
      .AddInputType<int>()
...
#undef _REGISTER_CINN_NVGPU_INDEX_ADD
  ...
  REGISTER_FACKED_EXTERN_FUNC_HELPER(cinn_sycl_resize_bilinear, target)
      .SetRetType<int>()
      .AddInputType<cinn_buffer_t *>()
      .AddInputType<int>()
      .AddInputType<int>()
  ...
  REGISTER_FACKED_EXTERN_FUNC_HELPER(cinn_sycl_resize_bicubic, target)
      .SetRetType<int>()
      .AddInputType<cinn_buffer_t *>()
      .AddInputType<int>()
      .AddInputType<int>()
